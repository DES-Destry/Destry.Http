...
/// <summary>
///     Response object, that MUST be returned by <see cref="Sender.SendHttpRequestAsync" /> method. <br /><br />
...
{
    /// <summary>
    ///     If some exception was thrown while <see cref="Sender.SendHttpRequestAsync" /> is executing it will be
    ...
    /// <summary>
    ///     HTTP Status Code of request after <see cref="Sender.SendHttpRequestAsync" /> method execution. <br />
    ///     See more on https://developer.mozilla.org/en-US/docs/Web/HTTP/Status
    /// </summary>
    public HttpStatusCode? Status { get; set; }

    /// <summary>
    ///     If <see cref="IsError" /> equals <see langword="false" />, therefore <see cref="Sender.SendHttpRequestAsync" />
    ...
    /// <summary>
    ///     If <see cref="IsError" /> equals <see langword="true" />, therefore <see cref="Sender.SendHttpRequestAsync" />
